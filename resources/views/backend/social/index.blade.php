        ...
        <table class="table table-striped table-hover table-bordered center_table" id="my_table">
            ...
            @foreach($allData as $data)
                <tr>
                    ...
                    <td><i class="{{($data->status==1)? 'fa fa-check-square-o text-success' : 'fa fa-times text-danger'}}"></i></td>
                    <td><a href="#editModal{{$data->id}}" data-toggle="modal" class="btn btn-info"><i class="fa fa-pencil-square"></i></a>
                    <!-- Modal -->
