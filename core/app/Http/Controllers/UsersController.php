...
class UsersController extends Controller
{
    ...
    {
        $allUsers=User::leftJoin('role_user','users.id','role_user.user_id')->leftJoin('roles','role_user.role_id','roles.id')->select('users.*','roles.name as type_name')->orderBy('users.id','DESC')->paginate(20);
    ...
    public function show($id)
    {
        ...
        $roles=DB::table('roles')->where('system',1)->pluck('name','id');
        return view('backend.user.show',compact('data','roles'));
    }
