                ...
                <article class="post">
                    <div class="post-thumb">
                         @if($data->feature_photo!=null)
                            <img class="img-responsive pull-left" src='{{asset("images/post/big/$data->feature_photo")}}' alt="">
                        @else
                        ...
                        <div class="single-item">
                            <a href='{{URL::to("post/$rel->id/$rel->link")}}'>
                                 @if($rel->feature_photo!=null)
                                    <img class="img-responsive pull-left" src='{{asset("images/post/small/$rel->feature_photo")}}' alt="">
                                @else
                                    <img class="img-responsive" src='{{asset("images/default/photo.png")}}' alt="">
                                @endif
                                <p>{{$rel->title}}</p>
