...
<head>
    ...
    @else
    <meta property="og:image" content="{{asset('images/logo/'.$info->logo)}}" />
    @endif
    <!-- favicon icon -->
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('public/prontend/js/html5shiv.js')}}"></script>
    <script src="{{asset('public/prontend/js/respond.js')}}"></script>
    <![endif]-->
    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href='{{URL::to("/")}}'><img src="{{asset('images/logo/'.$info->logo)}}" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    ...
                    ?>
                     <li  class="<? echo($url==$menu->url)?'current' : '' ?> {{(count($subMenus)>0)?'dropdown-toggle' : ''}}" data-toggle=" {{(count($subMenus)>0)?'dropdown' : ''}}"><a href='{{URL::to("$menu->url")}}'>{{$menu->name}}
                        @if(count($subMenus)>0)
