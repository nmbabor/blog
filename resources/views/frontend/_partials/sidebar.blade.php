<?php
    $popular=App\Models\Post::where(['status'=>1])->orderBy('hit','DESC')->simplePaginate(4);
    $category=App\Models\Post::leftJoin('categories','posts.fk_category_id','categories.id')->where('posts.status',1)->select(DB::raw('COUNT(*) as count'),'category_name','categories.link','fk_category_id')->groupBy(['fk_category_id','category_name','categories.link'])->get();
    ...
    @foreach($popular as $pop)
        <div class="popular-post">
            ...
            @if($pop->feature_photo!=null)
                <img class="img-responsive" src='{{asset("assets/images/post/small/$pop->feature_photo")}}' alt="{{$pop->title}}">
            @else
                <img class="img-responsive" src='{{asset("assets/images/post/default/default300x300.png")}}' alt="{{$pop->title}}">
            @endif
            </a>
        ...
        <div class="thumb-latest-posts">
            ...
            <div class="media">
                <div class="media-left">
                    <a href="index-grid.html#" class="popular-img"><img src="{{asset('assets/img/images/r-p.jpg')}}" alt="">
        ...
        <div id="widget-feature" class="owl-carousel">
            <div class="item">
                <div class="feature-content">
                    <img src="{{asset('assets/img/images/p1.jpg')}}" alt="">
            ...
            <div class="item">
                <div class="feature-content">
                    <img src="{{asset('assets/img/images/p2.jpg')}}" alt="">
            ...
            <div class="item">
                <div class="feature-content">
                    <img src="{{asset('assets/img/images/p3.jpg')}}" alt="">
