        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><a href="{{URL::to('/')}}"><img src='{{asset("assets/images/logo/$info->logo")}}' alt="{{$info->company_name}}" title="{{$info->company_name}}"></a></div>
...
<script type="text/javascript" src="{{asset('assets/frontend/js/jquery.stickit.min.js')}}"></script>
