                    ...
                    <div class="panel panel-info page-panel">
                        <div class="panel-heading">
                           Edit this post
                            ...
                            {!! Form::open(['route'=>['posts-admin.update',$data->id],'method'=>'PUT','role'=>'form','data-toggle'=>'validator','class'=>'form-horizontal','files'=>'true'])  !!}
                        <div class="panel-body min-padding">
                            <div class="col-md-9">
                                <div class="form-group  {{ $errors->has('title') ? 'has-error' : '' }}">
                                    {{Form::label('title','Title:',['class'=>'col-md-12'])}}
                                    <div class="col-md-12">
                                        {{Form::text('title',$data->title,['class'=>'form-control','placeholder'=>'Write Title','required'])}}
                                        @if ($errors->has('title'))
                                ...
                                <div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        {{Form::text('link',$data->link,['class'=>'form-control','placeholder'=>'Ex: best-tutorial-for-web-development','required'])}}
                                        @if ($errors->has('link'))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        {{Form::textArea('meta_description',$data->meta_description,['class'=>'form-control','placeholder'=>'Write short description about this post. ','rows'=>3])}}
                                ...
                                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        {{Form::textArea('description',$data->description,['class'=>'form-control tinymce','placeholder'=>'Write description here... ','rows'=>5,'required'])}}
                            ...
                            <div class="col-md-3 well min-padding">
                                ...
                                <div class="form-group {{ $errors->has('fk_sub_category_id') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12" id="subCategoryLoad">
                                       {{Form::select('fk_sub_category_id',$subCategory,$data->fk_sub_category_id,['class'=>'form-control','required','placeholder'=>'Select Sub Category','id'=>'subCategory'])}}
                                ...
                                <div class="form-group {{ $errors->has('is_pin') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        {{Form::select('is_pin',['1'=>'Top Featured','2'=>'Pin Post','0'=>'Normal'],$data->is_pin,['class'=>'form-control','required'])}}
                                    </div>
                                </div>
                                <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                    {{Form::label('status','Status:',['class'=>'col-md-12'])}}
                                    <div class="col-md-12">
                                        {{Form::select('status',['1'=>'Publish','0'=>'Draft'],$data->status,['class'=>'form-control','required'])}}
                                    </div>
                                </div>
                                <div class="form-group {{ $errors->has('feature_photo') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <img id="image_load" src='{{asset("assets/images/post/small/$data->feature_photo")}}' class="img-responsive">
                                        @else
                                ...
                                <div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input name="tags" id="tagboxField" value="{{$data->tags}}" type="hidden">
                                        <ul id="tagbox">
                                        </ul>
