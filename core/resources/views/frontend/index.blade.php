                        ...
                        @foreach($pinPost as $pin)
                            <div class="item">
                                ...
                                @if($pin->feature_photo!=null)
                                    <img class="img-responsive top_post_img" src='{{asset("assets/images/post/small/$pin->feature_photo")}}' alt="{{$pin->title}}">
                                @else
                                    <img class="img-responsive top_post_img" src='{{asset("assets/images/post/default/default300x300.png")}}' alt="{{$pin->title}}">
                                @endif
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="post-thumb">
                        <a href='{{URL::to("post/$bigPost->id/$bigPost->link")}}'>
                         @if($bigPost->feature_photo!=null)
                            <img class="img-responsive" src='{{asset("assets/images/post/big/$bigPost->feature_photo")}}' alt="">
                        @else
                        ...
                        <article class="post post-grid">
                            <div class="post-thumb">
                                ...
                                @if($post->feature_photo!=null)
                                    <img class="img-responsive" src='{{asset("assets/images/post/small/$post->feature_photo")}}' alt="">
                                @else
                                    <img class="img-responsive" src='{{asset("assets/images/default/photo.png")}}' alt="">
                                @endif
                                </a>
